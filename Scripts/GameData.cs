...
public class GameData
{
    ...
    public int price = 1000; //현재 가지고있는 돈

    public int clearStage = 1; //현재 언록한 스테이지

    public SerializableDictionary<int, float> stageTime =  new SerializableDictionary<int,float>(); //스테이지 클리어 시간   

    public SerializableDictionary<int, bool> tools = new SerializableDictionary<int,bool>(); //가지고있는 도구
}
